...
const Home = () =>{
  ...
  // MUTATIONS
  const [storeScribble1] = useMutation(MUTATION_CHORD_SCRIBBLE);
  const [storeScribble2] = useMutation(MUTATION_CHORD_SCRIBBLE);
  const [storeChordPairScribble] = useMutation(MUTATION_CHORD_PAIR_SCRIBBLE);
  ...
  const [getChord2List] = useLazyQuery(QUERY_FIRST_CHORD, {
  ...
  const [getChord1Scribble] = useLazyQuery(QUERY_SCRIBBLE, {
  ...
  const [getChord2Scribble] = useLazyQuery(QUERY_SCRIBBLE, {
    onCompleted: scribbleText => {
  ...
  const [getChordPairScribble] = useLazyQuery(QUERY_PAIR_SCRIBBLE, {
    onCompleted: scribbleText => {
      // if scribbleText exists for chosen chord... 
  ...
  const [getHistory] = useLazyQuery(QUERY_HISTORY, {
  ...
  useEffect(() => {
    ...
    // inject blank chord into diagrams at page load
  ...
  const handleMenu1Change = async (event) => {
    ...
    // hack to work with incompatible chord naming between apis
    if(value.includes('m')){
  ...
  // another hack to work with incompatible chord naming between apis
  ...
  const handleMenu2Change = async (event) => {
    ...
    updateHistory(history)
      if(value.includes('maj7')){
        // hack, musically incorrect but needed for mvp
            ...
            <div className="col">
              <div className="row">
                <div className="col-md-6">
                  ...
                  <div className="row">
                    <div className="col">
                    <GuitarChord frets={chord1Diagram}/>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col">
                ...
                <div className="col-md-6">
                  ...
                  <div className="row">
                    <div className="col">
                      <GuitarChord frets={chord2Diagram}/>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col">
